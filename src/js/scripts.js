...
jQuery(document).ready(function ($) {
    ...
    // ==== DISABLED SELECT2 ====
    $('#programmed-select2').select2({
        theme: 'bootstrap4'
    });
    $(".js-programmatic-enable").on("click", function () {
        $("#programmed-select2").prop("disabled", false);
    });
    $(".js-programmatic-disable").on("click", function () {
        $("#programmed-select2").prop("disabled", true);
    });


    $('#custom-list-select2').select2({
        theme: 'bootstrap4',
...
// Basic Select2
    $('#normal-pill-input-select').select2();

// Multiselect
    $('#normal-pill-input-multi').select2({
        placeholder: "Select options",
        allowClear: true
    });

// AJAX Select2
    $('#normal-pill-input-Ajax').select2({
        ajax: {
            url: '/api/select2-data', // replace with your endpoint
            dataType: 'json',
            delay: 250,
